...
$jscomp.findInternal = function (a, h, g) {
  ...
  for (var l = a.length, e = 0; e < l; e++) {
    var q = a[e];
    if (h.call(g, q, e, a)) return { i: e, v: q };
  }
  return { i: -1, v: void 0 };
};
$jscomp.ASSUME_ES5 = !1;
...
(function (a) {
      ...
      e
        ? (a(document).on("add.cards", function (b) {
          ...
          a(document).on("changeParameter.cards", function (b, d, f, e) {
            if ("bg" === d)
              switch (
                (a(b.target).jarallax("destroy").css("position", ""), e)
              ) {
                case "type":
    ...
    if (a.fn.socialLikes)
      a(document).on("add.cards", function (b) {
        a(b.target)
          ...
          .on("counter.social-likes", function (b, d, f) {
            999 < f &&
        ...
        f.on("scroll resize", function () {
          ...
          a.each(d, function () {
            var d = a(this),
              ...
              h = g.offsetHeight;
            g = c(g);
            if (((g + h >= f && g <= e) || b(d)) && d.hasClass("hidden"))
  ...
  if (!e && !a.isMobile()) {
    ...
    !p.find(".navbar").hasClass("collapsed") &&
      991 < r &&
      (p.find("ul.navbar-nav li.dropdown").hover(
        function () {
      ...
      p.find("ul.navbar-nav li.dropdown .dropdown-menu .dropdown").hover(
        function () {
          a(this).hasClass("open") || a(this).find("a")[0].click();
        },
        function () {
  ...
  e ||
    ("undefined" === typeof window.initClientPlugin &&
      ...
      a(document.body)
        .find(".clients")
        .each(function (b, c) {
          a(this).attr("data-isinit") || (h(a(this)), g(a(this)));
        })),
    ...
    "undefined" === typeof window.initTabsPlugin &&
      ((window.initTabsPlugin = !0), l(document.body)),
...
!(function () {
  ...
  if (!document.getElementById("top-1")) {
    ...
    a.className = "engine";
    a.innerHTML =
      '<a href="https://mobirise.in"> Mobirise Easy Web  Builder</a> v5.0.21';
